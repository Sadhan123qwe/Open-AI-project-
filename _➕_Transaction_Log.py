...
with st.expander("⬆ Add New Expense"):
    with st.form("expense_form"):
        ...
        exCategory = st.selectbox("Category of expense", ("-","Food 🍕","Personal 🧑","Transport 🚌","Inverstment "))
...
with st.expander(" ⬇ Add New Income"):
    with st.form("income_form"):
        ...
        InCategory = st.selectbox("Category of Income", ("-","Food 🍕","Personal 🧑","Transport 🚌","Inverstment "))
        submit_expense = st.form_submit_button("Add Income ➕")

        if submit_expense:
            account.addIncome(InDate, InName, InAmount, InCategory, InDes)
